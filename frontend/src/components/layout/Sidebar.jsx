...
function Sidebar() {
  ...
  const SidebarContent = () => (
    ...
    <motion.div
      ...
      className="sticky top-0 h-screen shrink-0 overflow-y-auto border-r border-slate-800 bg-slate-900/95 backdrop-blur z-40 flex flex-col shadow-2xl text-slate-100"
    >
