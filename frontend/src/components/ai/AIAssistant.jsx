...
function AIAssistant() {
  ...
  function handleKeyDown(e) {
    ...
    <div className="bg-slate-900 rounded-2xl shadow-xl border border-slate-800 overflow-hidden mt-8">
      ...
      <div className="bg-slate-900 border-b border-slate-800 text-slate-100 px-6 py-5 flex items-center justify-between">
...

          {
            ...
            suggestedPrompts.map((item) => (
              ...
              <button
                ...
                className="px-4 py-2 rounded-full bg-slate-800 border border-slate-700 text-slate-200 hover:bg-slate-700 hover:text-slate-100 transition"
      ...
      <div className="h-[350px] sm:h-[520px] overflow-y-auto px-6 py-6 bg-slate-900/50">
...

        {
          ...
          typing && (
            ...
            >
              ...
              <div className="bg-slate-800 border border-slate-700 rounded-2xl px-5 py-4 shadow text-slate-200">
      ...
      <div className="border-t border-slate-800 bg-slate-900 p-5">
        ...
        <div className="flex gap-3">
          ...
          <input
            ...
            className="flex-1 rounded-xl bg-slate-800 border border-slate-700 text-slate-100 px-5 py-3 outline-none focus:ring-2 focus:ring-blue-500 placeholder-slate-400"
          ...
          <button
            ...
            className="border border-slate-700 text-slate-300 rounded-xl px-5 hover:bg-red-900/30 hover:text-red-400 transition"
