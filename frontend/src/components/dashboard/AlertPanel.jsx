...
<div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-md p-8 mt-10">
...
className="border border-slate-700 bg-slate-800/30 rounded-2xl p-5 flex justify-between items-center hover:bg-slate-800/80 hover:shadow-md transition text-slate-100"
...
<div className="mt-10 bg-slate-800 border border-slate-700 rounded-2xl p-6 text-slate-100 flex justify-between items-center">
